...
use Municipal\PersonneBundle\Entity\Personnel;
use Municipal\PersonneBundle\Form\PersonnelType;
...
class PersonnelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MunicipalPersonneBundle:Personnel')->findAll();

        return $this->render('MunicipalPersonneBundle:Personnel:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MunicipalPersonneBundle:Personnel:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MunicipalPersonneBundle:Personnel')->find($id);
        ...
        return $this->render('MunicipalPersonneBundle:Personnel:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MunicipalPersonneBundle:Personnel:edit.html.twig', array(
            'entity'      => $entity,
